			...
			<div class="card shadow">
				<div class="card-body">
					<div class="form-group">
						...
						<input type="text" id="board_writer_name" name="board_write_name" class="form-control" value="${readContentBean.content_write_name }" disabled="disabled"/>
					</div>
					<div class="form-group">
