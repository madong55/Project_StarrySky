							...
							<c:choose>
								<c:when
									...
									<div class="form-group">
										...
										<form:input path="qna_date" class='form-control'
											readonly='true' />
									</div>
									<div class="form-group">
										<form:label path="qna_subject">제 목</form:label>
										<form:input path="qna_subject" class='form-control' disabled="disabled" />
									</div>

									<div class="form-group">
										<form:label path="qna_subject">[답변]</form:label>
									...
									<div class="form-group">
										<div class="text-right">
											<form:button class='btn btn-primary'>답변 완료</form:button>
											<a href="${root }shop/board/reply_read?qna_num=${qna_num}"
