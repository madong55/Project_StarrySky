						...
						<form:form action="${root }shop/board/write_pro" method="post" modelAttribute="writeQnAContentBean">
							...
							<div class="form-group">
								<div class="text-right">
									<form:button  class="btn btn-primary" style=" background-color: #666666; border-color: #666666" >작성하기</form:button>
									<a href="${root }shop/main?page=${page}" class="btn btn-info">취소</a>
								</div>
							</div>
